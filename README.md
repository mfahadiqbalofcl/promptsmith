...
**A free, open-source prompt compiler.** Describe what you want in plain English;
PROMPTSMITH compiles it into an expert-grade, structured prompt that an AI (Claude,
v0, Cursor, ChatGPT, etc.) executes far better than a casually-typed request — and it
...
| **Elementor** | design | Page templates, sections, headers/footers, popups — as a build recipe + Custom CSS |
